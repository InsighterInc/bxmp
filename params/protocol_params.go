...
const (
	...
	BitmedMaximumExtraDataSize uint64 = 65 // Maximum size extra data may be after Genesis.
)
...
func GetMaximumExtraDataSize(isBitmed bool) uint64 {
	if isBitmed {
		return BitmedMaximumExtraDataSize
	} else {
