...
func makeTestState() (Database, *bxmdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := bxmdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db bxmdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db bxmdb.Database, root common.Hash) error {
...
func checkStateConsistency(db bxmdb.Database, root common.Hash) error {
