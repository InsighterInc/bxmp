...
// Package state provides a caching layer atop the BitMED state trie.
package state
...
// StateDBs within the bitmed protocol are used to store anything
...
//
// Carrying over the balance ensures that BXM doesn't disappear.
