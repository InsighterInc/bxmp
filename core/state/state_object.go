...
// stateObject represents an BitMED account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of bitmed address of the account
	data     Account
	db       *StateDB
...
// Account is the BitMED consensus representation of accounts.
