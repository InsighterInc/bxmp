...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		name       string
		fn         func(bxmdb.Database) (*params.ChainConfig, common.Hash, error)
	...
	}{
		{
			...
			fn: func(db bxmdb.Database) (*params.ChainConfig, common.Hash, error) {
		...
		},
		{
			...
			wantConfig: &params.ChainConfig{HomesteadBlock: big.NewInt(3), IsBitmed: true},
		},
		{
