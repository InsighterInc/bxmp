...
// Package types contains data types related to BitMED consensus.
package types
...
// Header represents a block header in the BitMED blockchain.
type Header struct {
...
// Block represents an entire block in the BitMED blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package bxm to track
...
// [deprecated by bxm/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for bxm protocol, etc.
...
// EncodeRLP serializes b into the BitMED RLP block format.
