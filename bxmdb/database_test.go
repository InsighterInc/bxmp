...
func newTestLDB() (*bxmdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "bxmdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := bxmdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db bxmdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db bxmdb.Database, t *testing.T) {
	const n = 8
