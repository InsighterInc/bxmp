...
type OdrBackend interface {
	Database() bxmdb.Database
	Retrieve(ctx context.Context, req OdrRequest) error
}

// OdrRequest is an interface for retrieval requests
type OdrRequest interface {
	StoreResult(db bxmdb.Database)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db bxmdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db bxmdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db bxmdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db bxmdb.Database) {
