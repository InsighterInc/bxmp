...
// rules of the stock BitMED ethash engine.
...
func (ethash *Ethash) verifyHeader(chain consensus.ChainReader, header, parent *types.Header, uncle bool, seal bool) error {
	...
	maximumExtraDataSize := params.GetMaximumExtraDataSize(chain.Config().IsBitmed)
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/bitmed/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/bitmed/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/bitmed/EIPs/blob/master/EIPS/eip-2.mediawiki
	// algorithm:
	// diff = (parent_diff +
...
func (ethash *Ethash) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	isBitmed := chain != nil && chain.Config().IsBitmed
	...
	if !isBitmed && !bytes.Equal(header.MixDigest[:], digest) {
