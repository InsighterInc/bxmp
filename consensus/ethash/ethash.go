...
// all blocks' seal as valid, though they still have to conform to the BitMED
// consensus rules.
...
// still have to conform to the BitMED consensus rules.
...
// they still have to conform to the BitMED consensus rules.
