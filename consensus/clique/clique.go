...
// ecrecover extracts the BitMED account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the BitMED address
...
// BitMED testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     bxmdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // BitMED address of the signing key
...
func New(config *params.CliqueConfig, db bxmdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the BitMED address recovered
