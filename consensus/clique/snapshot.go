...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db bxmdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db bxmdb.Database) error {
