...
// See https://github.com/bitmed/EIPs/issues/176 for the test format specification.
...
func makePreState(db bxmdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/bitmed/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
