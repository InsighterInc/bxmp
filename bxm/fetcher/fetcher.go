...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (bxm/61) or header (bxm/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (bxm/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both bxm/61 and bxm/62)
}
