...
// information related to the BitMED protocol such als blocks, transactions and logs.
...
// `bxm_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/bitmed/wiki/wiki/JSON-RPC#bxm_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with bxm_getFilterChanges.
//
// https://github.com/bitmed/wiki/wiki/JSON-RPC#bxm_newblockfilter
...
//
// https://github.com/bitmed/wiki/wiki/JSON-RPC#bxm_newfilter
...
//
// https://github.com/bitmed/wiki/wiki/JSON-RPC#bxm_getlogs
...
//
// https://github.com/bitmed/wiki/wiki/JSON-RPC#bxm_uninstallfilter
...
//
// https://github.com/bitmed/wiki/wiki/JSON-RPC#bxm_getfilterlogs
...
//
// https://github.com/bitmed/wiki/wiki/JSON-RPC#bxm_getfilterchanges
