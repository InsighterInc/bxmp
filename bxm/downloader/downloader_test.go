...
type downloadTester struct {
	...
	stateDb bxmdb.Database // Database used by the tester for syncing from peers
	peerDb  bxmdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = bxmdb.NewMemDatabase()
