...
// Syncing provides information when this nodes starts synchronising with the BitMED network and when it's finished.
...
type SyncingResult struct {
	...
	Status  bitmed.SyncProgress `json:"status"`
}
