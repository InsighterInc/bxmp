...
// PeerInfo represents a short summary of the BitMED sub-protocol metadata known
...
// Handshake executes the bxm protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("bxm/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the BitMED sub-protocol.
type peerSet struct {
