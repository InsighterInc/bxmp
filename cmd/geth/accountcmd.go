...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage BitMED presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import BitMED presale wallet",
				ArgsUsage: "<keyFile>",
...
between bitmed nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another bitmed instance,
