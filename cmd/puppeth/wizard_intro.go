...
// setting up a new or managing an existing BitMED private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your BitMED private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new BitMED network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and bxmstats servers |")
	...
	log.Info("Administering BitMED network", "name", w.network)
