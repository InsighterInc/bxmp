...
// Package chequebook package wraps the 'chequebook' BitMED smart contract.
//
...
import (
	...
	"github.com/InsighterInc/bxmp/contracts/chequebook/contract"
	"github.com/InsighterInc/bxmp/core/types"
	"github.com/InsighterInc/bxmp/crypto"
	"github.com/InsighterInc/bxmp/log"
	"github.com/InsighterInc/bxmp/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an BitMED transaction.
