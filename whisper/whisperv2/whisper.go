...
import (
	...
	"github.com/InsighterInc/bxmp/crypto/ecies"
	"github.com/InsighterInc/bxmp/event/filter"
...
// Whisper represents a dark communication interface through the BitMED
...
// New creates a Whisper client ready to communicate through the BitMED P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
