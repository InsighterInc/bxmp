...
import (
	...
	"github.com/InsighterInc/bxmp/logger"
	"github.com/InsighterInc/bxmp/p2p"
	"github.com/InsighterInc/bxmp/p2p/nat"
	"github.com/InsighterInc/bxmp/whisper"
)
...
func main() {
	...
	// Create an BitMED peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting BitMED peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start BitMED peer: %v.\n", err)
		os.Exit(1)
	}
