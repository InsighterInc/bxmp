...
import (
	...
	"github.com/InsighterInc/bxmp/contracts/chequebook"
	...
	"github.com/InsighterInc/bxmp/swarm/fuse"
	"github.com/InsighterInc/bxmp/swarm/network"
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *bxmclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
