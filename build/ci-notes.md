...
We want to build BXMP with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Eethereum/+archive/ubuntu/bitmed/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/bitmed-unstable-1.6.0+xenial
    $ dpkg-buildpackage
