...
import (
	...
	"github.com/InsighterInc/bxmp/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			Name:        "abigen",
			Description: "Source code generator to convert BitMED contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			Name:        "bootnode",
			Description: "BitMED bootnode.",
		},
		{
			Name:        "evm",
			Description: "Developer utility version of the EVM (BitMED Virtual Machine) that is capable of running bytecode snippets within a configurable environment and execution mode.",
		},
		{
			Name:        "geth",
			Description: "BitMED CLI client.",
		},
		{
			Name:        "puppeth",
			Description: "BitMED private network manager.",
		},
		{
			Name:        "rlpdump",
		...
		{
			Name:        "swarm",
			Description: "BitMED Swarm daemon and tools",
		},
		{
			Name:        "wnode",
			Description: "BitMED Whisper diagnostic tool",
		},
	}
...
func doInstall(cmdline []string) {
	...
	if runtime.Version() < "go1.7" && !strings.Contains(runtime.Version(), "devel") {
		...
		log.Println("BXMP requires at least Go version 1.7 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:bitmed/bitmed")`)
...
type debMetadata struct {
	...
	// BXMP version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "BitMED Builds <builder@bitmed.io>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.bitmed", "-v", "github.com/InsighterInc/bxmp/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/InsighterInc/bxmp/mobile")
