...
!define HELPURL "https://github.com/InsighterInc/bxmp/issues"
!define UPDATEURL "https://github.com/InsighterInc/bxmp/releases"
!define ABOUTURL "https://github.com/InsighterInc/bxmp#bitmed-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gbxm.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gbxm.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gbxm.exe" "" "" "BitMED" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gbxm.exe" "" "" "BitMED" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gbxm.exe" "" "" "BitMED" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/bitmed/EIPs/issues/147)
  ${EnvVarUpdate} $0 "BITMED_SOCKET" "R" "HKLM" "\\.\pipe\gbxm.ipc"
  ${EnvVarUpdate} $0 "BITMED_SOCKET" "A" "HKLM" "\\.\pipe\gbxm.ipc"
