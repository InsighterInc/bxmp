...
// See https://github.com/bitmed/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
func (ks *KeyStore) SignTx(a accounts.Account, tx *types.Transaction, chainID *big.Int, isBitmed bool) (*types.Transaction, error) {
	// Look up the key to sign with and abort if it cannot be found
	ks.mu.RLock()
	defer ks.mu.RUnlock()
...
// ImportPreSaleKey decrypts the given BitMED presale wallet and stores
