...
// Package bind generates BitMED contract Go bindings.
//
// Detailed usage document and tutorial available on the BXMP Wiki page:
// https://github.com/InsighterInc/bxmp/wiki/Native-DApps:-Go-bindings-to-BitMED-contracts
package bind
