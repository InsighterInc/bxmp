...
const (
	...
	MessageType_MessageType_BitmedGetAddress       MessageType = 56
	MessageType_MessageType_BitmedAddress          MessageType = 57
	MessageType_MessageType_BitmedSignTx           MessageType = 58
	MessageType_MessageType_BitmedTxRequest        MessageType = 59
	MessageType_MessageType_BitmedTxAck            MessageType = 60
	...
	MessageType_MessageType_BitmedSignMessage      MessageType = 64
	MessageType_MessageType_BitmedVerifyMessage    MessageType = 65
	MessageType_MessageType_BitmedMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_BitmedGetAddress",
	57:  "MessageType_BitmedAddress",
	58:  "MessageType_BitmedSignTx",
	59:  "MessageType_BitmedTxRequest",
	60:  "MessageType_BitmedTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_BitmedSignMessage",
	65:  "MessageType_BitmedVerifyMessage",
	66:  "MessageType_BitmedMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_BitmedGetAddress":       56,
	"MessageType_BitmedAddress":          57,
	"MessageType_BitmedSignTx":           58,
	"MessageType_BitmedTxRequest":        59,
	"MessageType_BitmedTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_BitmedSignMessage":      64,
	"MessageType_BitmedVerifyMessage":    65,
	"MessageType_BitmedMessageSignature": 66,
...
// *
// Request: Ask device for BitMED address corresponding to address_n path
// @next PassphraseRequest
// @next BitmedAddress
// @next Failure
type BitmedGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *BitmedGetAddress) Reset()                    { *m = BitmedGetAddress{} }
func (m *BitmedGetAddress) String() string            { return proto.CompactTextString(m) }
func (*BitmedGetAddress) ProtoMessage()               {}
func (*BitmedGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *BitmedGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BitmedGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an BitMED address derived from device private seed
// @prev BitmedGetAddress
type BitmedAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BitmedAddress) Reset()                    { *m = BitmedAddress{} }
func (m *BitmedAddress) String() string            { return proto.CompactTextString(m) }
func (*BitmedAddress) ProtoMessage()               {}
func (*BitmedAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *BitmedAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next BitmedTxRequest
// @next Failure
type BitmedSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *BitmedSignTx) Reset()                    { *m = BitmedSignTx{} }
func (m *BitmedSignTx) String() string            { return proto.CompactTextString(m) }
func (*BitmedSignTx) ProtoMessage()               {}
func (*BitmedSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *BitmedSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BitmedSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *BitmedSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *BitmedSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *BitmedSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *BitmedSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *BitmedSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *BitmedSignTx) GetDataLength() uint32 {
...
func (m *BitmedSignTx) GetChainId() uint32 {
...
func (m *BitmedTxRequest) Reset()                    { *m = BitmedTxRequest{} }
func (m *BitmedTxRequest) String() string            { return proto.CompactTextString(m) }
func (*BitmedTxRequest) ProtoMessage()               {}
func (*BitmedTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *BitmedTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *BitmedTxRequest) GetSignatureV() uint32 {
...
func (m *BitmedTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *BitmedTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev BitmedTxRequest
// @next BitmedTxRequest
type BitmedTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BitmedTxAck) Reset()                    { *m = BitmedTxAck{} }
func (m *BitmedTxAck) String() string            { return proto.CompactTextString(m) }
func (*BitmedTxAck) ProtoMessage()               {}
func (*BitmedTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *BitmedTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next BitmedMessageSignature
// @next Failure
type BitmedSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *BitmedSignMessage) Reset()                    { *m = BitmedSignMessage{} }
func (m *BitmedSignMessage) String() string            { return proto.CompactTextString(m) }
func (*BitmedSignMessage) ProtoMessage()               {}
func (*BitmedSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *BitmedSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BitmedSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type BitmedVerifyMessage struct {
...
func (m *BitmedVerifyMessage) Reset()                    { *m = BitmedVerifyMessage{} }
func (m *BitmedVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*BitmedVerifyMessage) ProtoMessage()               {}
func (*BitmedVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *BitmedVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *BitmedVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *BitmedVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev BitmedSignMessage
type BitmedMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BitmedMessageSignature) Reset()                    { *m = BitmedMessageSignature{} }
func (m *BitmedMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*BitmedMessageSignature) ProtoMessage()               {}
func (*BitmedMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *BitmedMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *BitmedMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BitmedGetAddress)(nil), "BitmedGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*BitmedAddress)(nil), "BitmedAddress")
	...
	proto.RegisterType((*BitmedSignTx)(nil), "BitmedSignTx")
	proto.RegisterType((*BitmedTxRequest)(nil), "BitmedTxRequest")
	proto.RegisterType((*BitmedTxAck)(nil), "BitmedTxAck")
	proto.RegisterType((*BitmedSignMessage)(nil), "BitmedSignMessage")
	proto.RegisterType((*BitmedVerifyMessage)(nil), "BitmedVerifyMessage")
	proto.RegisterType((*BitmedMessageSignature)(nil), "BitmedMessageSignature")
